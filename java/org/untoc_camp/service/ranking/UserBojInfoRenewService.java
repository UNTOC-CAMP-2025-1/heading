...
public class UserBojInfoRenewService {
    ...
    private final CurrentUserBojInfoService currentUserBojInfoService; // ✅ 현재 정보 갱신 서비스 주입
        ...
        for (User user : users) {
            ...
            solvedAcClient.fetchInfo(handle).ifPresentOrElse(
                    stats -> {
                        ...
                        // ✅ 2. current_user_boj_info 갱신 (서비스 호출)
                        currentUserBojInfoService.updateCurrentInfo(handle, nickname);
